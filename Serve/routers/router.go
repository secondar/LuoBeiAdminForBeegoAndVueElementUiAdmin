...
func InitAdminRouter() {
	beego.Router("/admins", &admin.AdminHomeController{}, "GET:AdminHome")
	...
	ns := beego.NewNamespace("/admin/api",
		...
		beego.NSNamespace("/v1",
			beego.NSNamespace("/menu",
				beego.NSRouter("/add", &admin.AdminMenuController{}, "POST:Add"),
				beego.NSRouter("/edit", &admin.AdminMenuController{}, "POST:Edit"),
				beego.NSRouter("/delete", &admin.AdminMenuController{}, "POST:Delete"),
				beego.NSRouter("/list", &admin.AdminMenuController{}, "GET:List"),
				beego.NSRouter("/getadminmenurouter", &admin.AdminMenuController{}, "GET:GetAdminMenuRouter"),
			...
			beego.NSNamespace("/role",
				beego.NSRouter("/add", &admin.AdminRoleController{}, "POST:Add"),
				beego.NSRouter("/edit", &admin.AdminRoleController{}, "POST:Edit"),
				beego.NSRouter("/delete", &admin.AdminRoleController{}, "POST:Delete"),
				beego.NSRouter("/list", &admin.AdminRoleController{}, "GET:List"),
				beego.NSRouter("/settingrouter", &admin.AdminRoleController{}, "POST:SettingRouter"),
			),
			beego.NSNamespace("/router",
				beego.NSRouter("/setting", &admin.AdminRouterController{}, "POST:Setting"),
				beego.NSRouter("/getrouter", &admin.AdminRouterController{}, "POST:GetRoleRouter"),
			),
			beego.NSNamespace("/admin",
				beego.NSRouter("/getlist", &admin.AdminAdminController{}, "POST:GetList"),
				beego.NSRouter("/add", &admin.AdminAdminController{}, "POST:Add"),
				beego.NSRouter("/edit", &admin.AdminAdminController{}, "POST:Edit"),
				beego.NSRouter("/delete", &admin.AdminAdminController{}, "POST:Delete"),
			),
