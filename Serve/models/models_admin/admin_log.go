...
// 获取ORM
func (_this *AdminLogModel) NewAdminLogModelOrm() {
	if _this.Orm == nil {
...
// 获取QS
func (_this *AdminLogModel) NewAdminLogModelQs() {
	if _this.Orm == nil {
		_this.NewAdminLogModelOrm()
	}
	if _this.Qs == nil {
...
//添加日志
func (_this *AdminLogModel) Add(LogData AdminLog) (int64, error) {
	if _this.Orm == nil {
		_this.Orm = orm.NewOrm()
	}
	return _this.Orm.Insert(&LogData)
}
